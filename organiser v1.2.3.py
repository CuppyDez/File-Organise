    ...
    def trigger_popup(self, file_name, file_path, main_root):
        ...
        def option_new():
            ...
            if parent_folder:
                ...
                if new_folder_name:
                    ...
                    try:
                        ...
                        if not os.path.exists(new_folder_path):
                            ...
                            #destroy popup after successful folder creation         
                            root.destroy()
                ...
                #if canceled at intial parent folder select
                root.deiconify()
        ...
        btnleave.pack(fill='x', padx=20, pady=25)
...
#create hidden master window on main thread
main_root = tk.Tk()
main_root.withdraw() #keep hidden
