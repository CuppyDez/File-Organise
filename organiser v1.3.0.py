...
btn_add_rule.pack(fill='x', padx=40, pady=5)

btn_remove_rule = tk.Button(main_root, text="Remove Custom Auto-Sort Rule", command=dashboard_remove_rule)
btn_remove_rule.pack(fill='x', padx=40, pady=5)

btn_open_downloads = tk.Button(main_root, text="Open Downloads Folder", command=dashboard_open_downloads)
btn_open_downloads.pack(fill='x', padx=40, pady=5)

btn_exit = tk.Button(main_root, text="Exit & Stop Monitoring", command=main_root.destroy)
btn_exit.pack(fill='x', padx=40, pady=5)
